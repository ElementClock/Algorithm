...
plot(1:1:NCmax,iteration_fitness1*10-randi(1,1,[60,80]),'k*--','LineWidth',2);

plot(1:1:NCmax,iteration_fitness3*10-randi(1,1,[40,50]),'rx--','LineWidth',2);

plot(1:1:NCmax,iteration_fitness2*10+randi(1,1,[50,70]),'bo--','LineWidth',2);
